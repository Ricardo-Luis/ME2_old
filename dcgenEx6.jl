...
#############################################
	using Pkg
	Pkg.add(["PlutoUI", "Plots", "Dierckx"])	# instalação 
#############################################
...
ISEL, 06/Abr/2021\
*Notebook* realizado em linguagem de programação *Julia* versão: v"1.5.2"
"""
...
md"""
Do gráfico, na característica $$U=f(I₁+I₂)$$, para uma carga de $$1500$$A, verifica-se: $$U\eqsim215$$V, $$I₁\eqsim650$$A e $$I₂\eqsim850$$A.
"""
...
begin
	plot(I,U₁, markershape=:circle, markersize=3, linecolor=:blue, linewidth=0, title="U =f(I)", xlabel = "I(A)", ylabel="U(V)", ylims=(0,230), framestyle = :origin, minorticks=5, label="U₁=f(I₁)") # alterar o parâmetro "ylims" para a fazer zoom ao gráfico!
